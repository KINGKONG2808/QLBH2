<<<<<<< HEAD:QuanLyBanHang/QuanLyBanHang/QuanLyBanHang_Code/Quan_Ly_Ban_Hang[object]/GUI/QL_NhanVienGUI.cs
﻿using System;
...
namespace QL_BanHang
{
    public partial class QL_NhanVien : Form
    {
        ...
        private void ganDuLieu(NhanVienObj nv)
        {
            nv.MaNV = txtMaNV.Text;
            nv.TenNV = txtTenNV.Text;
            nv.GioiTinh = cboGioiTinh.Text;
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(txtMaNV.Text))
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    try
                    {
                        nvbll.DeleteNhanVien(txtMaNV.Text.Trim());
                        {
                            MessageBox.Show("Xóa thành công", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            Form1_Load(sender, e);
                            setTXT();
...
>>>>>>> bf1d8d3475cb48832f4be5f09d1baa34d5fb0852:QuanLyBanHang/QuanLyBanHang/QuanLyBanHang_Code/Quan_Ly_Ban_Hang[object]/GUI/QL_NhanVien.cs
